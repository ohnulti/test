...
<head>
    ...
    <link rel="icon" type="image/png" href="dist/images/icons/Checklist.png"/>
    <!-- Font Awesome -->
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <button type="button" class="btn btn-danger " data-toggle="modal" data-target="#myModal"><h5><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;ทำรายการยืม</h5></button>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="container-fluid">
                                    <fieldset class="col-md-12">
                                        <legend>ทำรายการยืมครุภัณฑ์</legend> <form class="needs-validation" novalidate>
